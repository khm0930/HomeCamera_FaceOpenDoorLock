...
cred = credentials.Certificate("/home/js/HomeCamera_FaceOpenDoorLock/Artifical Intelligence/serviceAccount.json") # Service Key Path
...
def fileUpload(file):
    ...
    #upload file
    blob.upload_from_filename(filename='/home/js/HomeCamera_FaceOpenDoorLock/'+file, content_type='image/png') #파일이 저장된 주소와 이미지 형식(jpeg도 됨)
    #debugging hello
    print("hello ")
